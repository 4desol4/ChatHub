...
git init
git add .
git commit -m "Initial commit: ChatHub application"
```
...
3. Name: `ChatHub`
4. Description: `Java Desktop Chat Application`
...
git remote add origin https://github.com/yourusername/ChatHub.git
...
5. Or: VCS → Git → Push → "Push"

**Alternative - Built-in Git UI:**

1. Bottom right → Git
2. Click "Commit"
3. Type message and commit
4. Right-click branch → Push
...
```markdown
![Screenshot of Chat](screenshots/chat.png)
```

### Method 2: GitHub Raw Content

```markdown
![Screenshot](https://raw.githubusercontent.com/yourusername/ChatHub/main/screenshots/chat.png)
```

### Method 3: Using Markdown Tables
...
git commit -m "feat: Add one-on-one messaging feature"
git commit -m "fix: Resolve database connection timeout issue"
git commit -m "docs: Update README with installation guide"
git commit -m "style: Format code according to style guide"
git commit -m "refactor: Extract message filtering logic"
